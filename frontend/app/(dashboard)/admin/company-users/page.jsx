...
const CompanyUsersManagementPage = () => {
  ...
  const loadUsers = async () => {
    try {
      setLoading(true);
      // Mock data - apenas usuários da empresa atual
      const mockUsers = [
        {
          id: 1,
          name: "Ivan Alberton",
        ...
        },
        {
          ...
          email: "maria.santos@navi.inf.br",
          cpf: "123.456.789-01",
          phone: "(11) 99999-9999",
          role: "ADMIN",
          status: "active",
          ...
          lastLogin: "2025-01-18T08:45:00Z",
          loginCount: 856,
          transactions: 9234,
          balance: 75000.25,
        ...
        },
        {
          ...
          email: "joao.oliveira@navi.inf.br",
          cpf: "987.654.321-00",
          phone: "(21) 98888-7777",
          role: "USER",
          status: "active",
          ...
          lastLogin: "2025-01-17T16:20:00Z",
          loginCount: 234,
          transactions: 1567,
          balance: 25000.75,
          publicKey: "0x9876543210987654321098765432109876543210",
          privateKey: permissions.canViewSensitiveData ? "0x9876543210987654321098765432109876543210987654321098765432109876" : "***REDACTED***",
          avatar: null
        },
        {
          id: 4,
          name: "Ana Carolina Lima",
          email: "ana.lima@navi.inf.br",
          cpf: "456.789.123-45",
          phone: "(85) 97777-6666",
          role: "USER",
          status: "inactive",
          ...
          privateKey: permissions.canViewSensitiveData ? "0xabcdef1234567890abcdef1234567890abcdef1234567890abcdef1234567890" : "***REDACTED***",
          avatar: null
        },
        {
          id: 5,
          name: "Carlos Eduardo Silva",
          email: "carlos@navi.inf.br",
          cpf: "654.321.987-88",
          phone: "(62) 96666-5555",
          role: "USER",
          status: "pending",
          ...
          transactions: 0,
          balance: 0,
          publicKey: "0x5555555555555555555555555555555555555555",
          privateKey: permissions.canViewSensitiveData ? "0x5555555555555555555555555555555555555555555555555555555555555555" : "***REDACTED***",
          avatar: null
        },
        {
          id: 6,
          name: "Patricia Alves Costa",
          email: "patricia@navi.inf.br",
          cpf: "321.654.987-11",
          phone: "(47) 95555-4444",
          role: "ADMIN",
          status: "blocked",
          ...
          privateKey: permissions.canViewSensitiveData ? "0x7777777777777777777777777777777777777777777777777777777777777777" : "***REDACTED***",
          avatar: null
        }
      ];
      ...
      const newStats = {
        ...
        inactive: mockUsers.filter(u => u.status === 'inactive' || u.status === 'blocked').length,
        admins: mockUsers.filter(u => u.role === 'ADMIN' || u.role === 'APP_ADMIN').length,
...
export default CompanyUsersManagementPage;