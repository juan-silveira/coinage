          ...
          <div className="space-y-6">
            ...
            <div className="max-w-md mx-auto">
                  ...
                  onChange={(e) => {
                    ...
                    console.log('Input original:', inputValue); // Debug
                    
                    // Se não tem vírgula, formatar como inteiro
                    if (!inputValue.includes(',')) {
                      const formattedValue = formatInputValue(inputValue);
                      console.log('Valor inteiro formatado:', formattedValue);
                      ...
                      if (integerPart && decimalPart === '') {
                        ...
                        console.log('Mantendo vírgula para decimais:', finalValue);
                      ...
                      if (integerPart && !decimalPart && !inputValue.includes(',')) {
                        const formattedInteger = formatInputValue(integerPart);
                        console.log('Vírgula removida, formatando como inteiro:', formattedInteger);
                        setDepositAmount(formattedInteger);
                        return;
                      }
                      ...
                      console.log('Valor com decimais formatado:', finalValue);
                      setDepositAmount(finalValue);
                    }
                  }}
                                      onBlur={(e) => {
                    // Quando sair do campo, se não tem decimais, adicionar ,00
                    if (depositAmount && !depositAmount.includes(',')) {
                      setDepositAmount(depositAmount + ',00');
                    }
                  }}
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-xl font-bold text-primary-600">
                      {(() => {
                        const cleanValue = depositAmount.replace(/[^\d,]/g, '').replace(',', '.');
                  ...
                  <div className="mt-4 p-3 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg">
                    <p className="text-xs text-blue-800 dark:text-blue-200">
                      <strong>Importante:</strong> O valor será convertido para
                      cBRL na blockchain Azore após a confirmação do pagamento.
                    </p>
                  </div>
                </div>
              </Card>
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div className="space-y-6">
          <div className="text-center">
            {/* <Icon icon="heroicons:currency-dollar" className="w-16 h-16 text-primary-500 mx-auto mb-4" /> */}
            <h3
            ...
            >
              Para depositar tokens, você precisa ter a rede Azore configurada
              na sua{" "}
              <span
            ...
            {(cachedUser?.publicKey || user?.publicKey) && (
              ...
              >
                ...
                <div
                  className={`font-mono text-xs break-all text-center ${
          ...
          >
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between items-center">
                ...
                >
                  https://rpc-mainnet.azore.technology
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span
